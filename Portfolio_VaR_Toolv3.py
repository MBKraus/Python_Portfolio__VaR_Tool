...
class PageTwo(wx.Panel):
    ...
    def myListener(self, arg1, arg2, arg3, arg4):
        ...
        port.rename(columns={'returns': 'Portfolio',}, inplace=True)
        ...
        axes_5.hist(port["Portfolio"].dropna(), bins=50, normed=True, histtype='stepfilled', alpha=0.5)
        ...
        portfolio_cum = (1 + port["Portfolio"].dropna()).cumprod()
...
class PageThree(wx.Panel):
    ...
    def myListener(self, arg1, arg2, arg3, arg4):
        ...
        portfolio_hist_ret = portfolio["returns"].dropna()
        ...
        portfolio_return_daily = portfolio["returns"].dropna().mean()
        portfolio_std = portfolio["returns"].dropna().std()
